...
from core.voice.VoiceGen.so_vits_svc_fork.f0 import f0_to_coarse
from core.voice.VoiceGen.so_vits_svc_fork.modules import commons as commons
from core.voice.VoiceGen.so_vits_svc_fork.modules.decoders.f0 import F0Decoder
from core.voice.VoiceGen.so_vits_svc_fork.modules.decoders.hifigan import NSFHifiGANGenerator
from core.voice.VoiceGen.so_vits_svc_fork.modules.decoders.mb_istft import (
    Multiband_iSTFT_Generator,
    Multistream_iSTFT_Generator,
    iSTFT_Generator,
)
from core.voice.VoiceGen.so_vits_svc_fork.modules.encoders import Encoder, TextEncoder
from core.voice.VoiceGen.so_vits_svc_fork.modules.flows import ResidualCouplingBlock

LOG = getLogger(__name__)

from .. import f0 as f0_imported
...
class SynthesizerTrn(nn.Module):
    ...
    def forward(self, c, f0, uv, spec, g=None, c_lengths=None, spec_lengths=None):
        ...
        norm_lf0 = f0_imported.normalize_f0(lf0, x_mask, uv)
    ...
    def infer(self, c, f0, uv, g=None, noice_scale=0.35, predict_f0=False):
        ...
        if predict_f0:
            lf0 = 2595.0 * torch.log10(1.0 + f0.unsqueeze(1) / 700.0) / 500
            norm_lf0 = f0_imported.normalize_f0(
