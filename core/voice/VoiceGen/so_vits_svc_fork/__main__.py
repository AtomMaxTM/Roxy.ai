...
from core.voice.VoiceGen.so_vits_svc_fork import __version__
from core.voice.VoiceGen.so_vits_svc_fork.utils import get_optimal_device
...
def vc(
    ...
    from core.voice.VoiceGen.so_vits_svc_fork.inference.main import realtime
...
def pre_resample(
    ...
    from core.voice.VoiceGen.so_vits_svc_fork.preprocessing.preprocess_resample import preprocess_resample
...
from core.voice.VoiceGen.so_vits_svc_fork.preprocessing.preprocess_flist_config import CONFIG_TEMPLATE_DIR
...
def pre_config(
    ...
    from core.voice.VoiceGen.so_vits_svc_fork.preprocessing.preprocess_flist_config import preprocess_config
...
def pre_hubert(
    ...
    from core.voice.VoiceGen.so_vits_svc_fork.preprocessing.preprocess_hubert_f0 import preprocess_hubert_f0
...
def pre_sd(
    ...
    from core.voice.VoiceGen.so_vits_svc_fork.preprocessing.preprocess_speaker_diarization import (
...
def pre_split(
    ...
    from core.voice.VoiceGen.so_vits_svc_fork.preprocessing.preprocess_split import preprocess_split
...
def pre_classify(
    ...
    from core.voice.VoiceGen.so_vits_svc_fork.preprocessing.preprocess_classify import preprocess_classify
...
def onnx(
    ...
    from core.voice.VoiceGen.so_vits_svc_fork import onnx_export
