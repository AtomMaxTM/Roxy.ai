...
import core.voice.VoiceGen.so_vits_svc_fork.modules.commons as commons
            ...
            self.log_image_dict(
                {
                    ...
                    "all/lf0": Server.Voice.so_vits_svc_fork.utils.plot_data_to_numpy(
                        lf0[0, 0, :].cpu().float().numpy(),
                        pred_lf0[0, 0, :].detach().cpu().float().numpy(),
                    ),
                    "all/norm_lf0": Server.Voice.so_vits_svc_fork.utils.plot_data_to_numpy(
                        lf0[0, 0, :].cpu().float().numpy(),
